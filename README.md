...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/colcon-defaults-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8113&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/colcon-defaults-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `colcon-defaults` can be installed with:

```
conda install colcon-defaults
```

It is possible to list all of the versions of `colcon-defaults` available on your platform with:
